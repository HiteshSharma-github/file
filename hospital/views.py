...
def send_notification(registration_ids, message_title, message_desc):
    fcm_api = "AAAACKCzIxs:APA91bFbnS89GKGhr8eFiuabIqyBrxwag7rpdazC76kMF1EKbN-y_GzhmObtXQBVlLbeoePeiGDLLNIZX-ZXlfgLTZcVhJ-ZoSe5NhJU695h7E_FDU8pcpJfjADYJ6RX3D7wUvsaN-bU"
...
def send(request):
    resgistration = ['clf3wBfqlce1twcTM-GJdu:APA91bFFOhgP_t-QYCsQ-6O2m72j6IPaBZznjzfga7Czk1kC0yJF5ZT-mox6HVGXYnQElgc6EX8IarRL1A1I6IOwkCH7QWCB8swVygJ32P-GZKFds5eTxgPj-wJN9KJNPb6iPJUPcy-n'
                     ]
    send_notification(
...
def showFirebaseJS(request):
    data = 'importScripts("https://www.gstatic.com/firebasejs/8.2.0/firebase-app.js");' \
        ...
        'var firebaseConfig = {' \
        '        apiKey: "AIzaSyBNAiMqYLxZM7BGCEXjVaVrq1nwbKODYJU",' \
        '        authDomain: "hmdds-c4927.firebaseapp.com",' \
        '        projectId: "hmdds-c4927",' \
        '        storageBucket: "hmdds-c4927.appspot.com",' \
        '        messagingSenderId: "37055832859",' \
        '        appId: "1:37055832859:web:80048df37b4e400fa2a9be",' \
        '        measurementId: "G-DETE5H4X9B"' \
        ' };' \
